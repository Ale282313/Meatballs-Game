...
@login_required
def get_statistics():
    winner = request.args.get('winner', "undefined")
    game_duration = request.args.get('game_duration', 0)
    player1_username = request.args.get('player1_username', "undefined")
    player1_total_shots = request.args.get('player1_totalShots', 0)
    player1_hit_shots = request.args.get('player1_hitShots', 0)
    player1_shield_activation = request.args.get('player1_shieldActivation', 0)
    player2_username = request.args.get('player2_username', "undefined")
    player2_total_shots = request.args.get('player2_totalShots', 0)
    player2_hit_shots = request.args.get('player2_hitShots', 0)
    player2_shield_activation = request.args.get('player2_shieldActivation', 0)
